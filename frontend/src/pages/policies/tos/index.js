  ...
  return (
    <div className={styles.container}>
      <Card className={styles.card}>
        ...
        <h2>User Accounts</h2>
        <p>
          When you create an account with Us, you may provide us with inaccurate
          information.
        </p>
        <p>
          You are responsible for safeguarding the password that You will use to
          access the Service.
        </p>
        ...
        <p>
          ...
          our copyright agent via email (anthonyliang011@gmail.com) and include
